...
export abstract class ExportBuilder implements IReflectionContext {
     ...
     */
    protected abstract onMeetsContext(reflectedTarget: Constructor<any>): boolean;
     ...
     */
    protected abstract onGetExport(reflectedTarget: Constructor<any>, exportTarget: Constructor<any>,  exportProvider: IExportProvider): Promise<ILazyExport<any>>;
}
