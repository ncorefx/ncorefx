...
/**
 * Associates an import target that imports an export of the reflected type with the decorated parameter.
 */
export function importAs(): ParameterDecorator
/**
 * Associates an import target that imports an export of the given reflected type with the decorated
 * parameter.
 * 
