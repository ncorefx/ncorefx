...
export interface IReflectionContext {
     ...
     */
    meetsContext(reflectedTarget: Constructor<any>): boolean;
     ...
     */
    getExport(reflectedTarget: Constructor<any>, exportTarget: Constructor<any>, exportProvider: IExportProvider): Promise<ILazyExport<any>>;
}
