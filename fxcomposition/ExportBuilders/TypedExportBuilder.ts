...
export abstract class TypedExportBuilder<T> extends ExportBuilder implements IExportBuilderFluentOptions<T> {
    ...
    private _builderFunc: (exportProvider: IExportProvider, target: Constructor<T>, importTargets?: ImportTarget[]) => Promise<T>;
     ...
     * rule.
     */
    constructor(assignedPriority: number, exportTarget: Constructor<any>) {
    ...
    public exportAs<TDerived>(...baseTargets: Constructor<TDerived>[]): IExportBuilderFluentCreationOptions<T> {
        ...
        this._exportTargets = new ExportTargetSet(baseTargets);
     ...
     * required.
     */
    public constructWith(builderFunc: (exportProvider: IExportProvider, target: Constructor<T>) => Promise<T>): IExportBuilderFluentExportOptions<T> {
     ...
     */
    protected isExportTargetOf(target: Constructor<any>): boolean {
